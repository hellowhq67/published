        ...
        {loading ? null : !user ? (
          <div className={style.btnCol}>
            ...
            <p style={{ textAlign: "start" }}>
              By creating an account on Grailed you will be able to buy sell
              comment and more
            </p>
            <button onClick={handelAppel} className={style.btn}>
              <svg
            ...
            <button onClick={handelFaceBook} className={style.btn1}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="26"
                height="26"
          ...
          >
            ...
            <p>
              ...
              pieces from the world’s top brands
            </p>
          </div>
        )}
      </div>
