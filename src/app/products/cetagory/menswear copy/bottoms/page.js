...
export default function page() {
  ...
  const fetchProducts = async () => {
    try {
      ...
      // Filter products with category "BOTTOMS" and department "MENSWEAR"
  ...
  const filterProducts = (product) => {
    ...
    if (topsChecked && product.category !== "BOTTOMS") {
      return false;
    }
    return true;
  };
  ...
  return (
    ...
    <div>
      ...
      <div className={style.wrapper2}>
        ...
        <span style={{ fontWeight: "bold" }}>{products.length} listings  <Link href=''>menswear{`>`}bottoms</Link></span>
