            ...
            return <>
              ...
              <div key={x._id} className={style.ProductSildes}>
                ...
                <div className={style.priceCol}>
                  ...
                  {x._id && <button className={style.btn} onSubmit={() => followProduct()}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width={30}>
